    ...
    <div>
      ...
      <main>
        ...
        <section className="px-6 py-5 mx-6 mt-8 text-lg leading-7 break-words whitespace-pre-wrap border-b-2 sm:mx-8 lg:mx-16 rounded-2xl bg-background border-purple-600/20 text-purple-100/90 font-overpass editor">
          ...
          <h4 className="pt-8 pb-6">Verantwortlicher</h4>
          <div className="mb-8">
          ...
          <h4 className="pb-6">Arten der verarbeiteten Daten</h4>
          <div className="mb-8">
            <p>- keine</p>
          </div>
          <h4 className="pb-6">Kategorien betroffener Personen</h4>
          <div className="mb-8">
            <p>
          ...
          <h4 className="pb-6">Zweck der Verarbeitung</h4>
          <div className="mb-8">
            <p>Wir verarbeiten keine Nutzerdaten.</p>
          </div>
          <h4 className="pb-6">Einbindung von Diensten und Inhalten Dritter</h4>
          <div className="mb-8">
            <p>
          ...
          <h4 className="pb-6">Google Fonts</h4>
          <div className="mb-2">
            <p>
